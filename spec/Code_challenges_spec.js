...
describe("Pick peaks", ()=>{
    it("Should be a function", ()=>{
        expect(typeof pickPeaks).toEqual("function")
    })
    it("Should return empty if the input is empty",()=>{
        expect(pickPeaks([])).toEqual({pos:[],peaks:[]})
    })
    it("Should return the peaks and the positions", ()=>{
...
describe('Deletable prime', ()=>{
    it("Should be a function", ()=>{
        expect(typeof delPrime).toEqual("function")
    })
    it("Should return if a number is prime or not prime", ()=>{
        // expect(delPrime(3)).toEqual('prime')
        expect(delPrime(4125673)).toEqual('prime')
        // expect(delPrime(2)).toEqual('prime')
        // expect(delPrime(4)).toEqual('not prime')
    })
})